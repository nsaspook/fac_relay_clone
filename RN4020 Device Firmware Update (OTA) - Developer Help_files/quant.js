...
if (!__qc) {
    var __qc = {qs: 'quantserve.com', ql: 'quantcount.com', pixelcalls: [], pmto: null, pmc: undefined, qcdst: function () {
            ...
            if (a.length > 0) {
                try {
                    var c = parseInt(a.split('-')[2], 10);
                    if (da - c > t) {
                        u.cookie = "__qca=" + a + "; expires=" + new Date(c + t).toGMTString() + "; path=/; domain=" + d;
                    }
                } catch (e) {
                }
                s += ";fpan=0;fpa=" + a;
            }
            if (__qc.qcgc("__qca").length == 0) {
                a = 'P0-' + __qc.qcrnd() + '-' + da.getTime();
                u.cookie = "__qca=" + a + "; expires=" + new Date(da.getTime() + t).toGMTString() + "; path=/; domain=" + d;
                a = __qc.qcgc("__qca");
                if (a.length > 0) {
                    s += ";fpan=1;fpa=" + a;
                }
            ...
            var params = {PrivacyManagerAPI: {timestamp: new Date().getTime(), action: action, self: __qc.qs, domain: __qc.qcdomain(), authority: "truste.com", type: type}};
            ...
            __qc.pixelcalls.push({p1: p1, p2: p2});
            __qc.firepixels();
        }, fire: function (o) {
            var src = 'http';
