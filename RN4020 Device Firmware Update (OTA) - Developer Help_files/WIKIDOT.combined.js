var WIKIDOT = {};
var WIKIDOT = {page: function () {
    }, modules: function () {
    }, utils: function () {
    }, vars: function () {
    }};
WIKIDOT.utils = {changeTextareaRowNo: function (b, d) {
        var c = $(b);
        if ((d < 0 && c.rows + d >= 5) || (d > 0 && c.rows + d <= 50)) {
            c.rows = c.rows + d
        }
    }};
WIKIDOT.captcha = {reloadMathCaptcha: function (b) {
        p = new Object();
...
WIKIDOT.visuals = {showCenterMessage: function (c) {
...
WIKIDOT.render.fixAvatarHover.showHover = function (m) {
    ...
    if (this.hoverAvatar == null) {
        ...
        var b = new fx.Opacity(o, {duration: 200});
...
WIKIDOT.page.listeners = {editClick: function (g) {
        ...
        var b = new fx.Opacity("page-options-bottom-2", {duration: 200});
        b.setOpacity(0);
        ...
        if (WIKIDOT.page.vars.editSectionsActive == false) {
            ...
            for (var k = 0; k < t.length; k++) {
                ...
                var h = new fx.Opacity(q, {duration: 300});
                h.setOpacity(0);
        ...
        if (b) {
            if (("page-options-bottom")) {
                var c = new fx.ScrollBottom({duration: 100, transition: fx.sineOut});
        ...
        var b = new fx.Opacity($("toc-list"), {duration: 200, onComplete: function () {
        ...
        var c = new fx.Opacity($("toc-list"), {duration: 200});
        c.setOpacity(0);
        ...
        OZONE.ajax.requestModule(k, c, function (m) {
            ...
            if (!d) {
                ...
                for (i = 0; i < n.length; i++) {
                    var e = new fx.Opacity(n[i], {duration: 300});
                    e.setOpacity(0);
                    $j(n[i]).html(m.body);
                    e.custom(0, 1)
                }
...
WIKIDOT.page.callbacks = {filesClick: function (b) {
...
WIKIDOT.page.utils = {scrollToReference: function (b) {
...
WIKIDOT.page.fixers = {fixMathRef: function () {
        ...
        for (var h = 0; h < m.length; h++) {
            ...
            for (var f = 0; f < o.length; f++) {
                ...
                if (!e) {
                    ...
                    g.eff = new fx.Opacity(l, {duration: 300});
...
WIKIDOT.page.account.shower = function (c) {
    ...
    if (!b.eff) {
        b.eff = new fx.Opacity(b, {duration: 200})
    }
    b.eff.setOpacity(0);
...
(function (c) {
    c("div.wikidot-hybrid-module[id^=wikidot-hybrid-module-]").livequery(function () {
        ...
        }, null, {noCursorWait: true, ignoreCodeZero: true})
    });
...
WIKIDOT.Editor.buttons = {bold: function (b) {
...
WIKIDOT.Editor.listeners = {tableWizardInsert: function (h) {
